...
def getClues(guess, secretNum):
      # Return a string of Pico, Fermi, & Bagels clues to the user.
      if guess == secretNum:
            return 'You got it!'
...
def isOnlyDigits(num):
      # Return True if num is a string o fonly digits. Otherwise, returns False.
      if num == '':
            return False
...
print('I am thinking of a %s number. Try to guess what it is.' % (MAX_GUESS))
